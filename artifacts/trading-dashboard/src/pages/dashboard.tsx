...
import { useGetStats, useListOrders, useGetLogs } from "@workspace/api-client-react";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Activity, ArrowRightLeft, CheckCircle2, XCircle, AlertTriangle } from "lucide-react";
...
function StatCard({ title, value, icon: Icon, color }: { title: string, value: number | string | null, icon: any, color: string }) {
  return (
